...
<div class="highlight-box">
    <p>CrowdCamp is a workshop with its own registration and fee, separate from the main conference. You can register for the workshop on its own, for the full conference, or for both.</p>
</div>

<div class="cta-box">
    <h3>Take part in CrowdCamp 2026</h3>
    <p>Express your interest by Monday, August 31, then complete your workshop registration.</p>
...
<div class="row profile-row" style="margin-top: 2rem;">
  <div class="col-md-3">
    <img class="photo-size rounded-circle hcomp-img" src="images/OC/Brian-McInnis.jpg" alt="Brian McInnis">
    ...
    <p class="lead" style="font-size: 0.95rem;">University of Texas at Austin, USA</p>
  </div>
  <div class="col-md-3">
    <img class="photo-size rounded-circle hcomp-img" src="images/OC/Stephanie-Valencia.jpg" alt="Stephanie Valencia">
    ...
    <p class="lead" style="font-size: 0.95rem;">University of Maryland, College Park, USA</p>
  </div>
  <div class="col-md-3">
    <img class="photo-size rounded-circle ci-img" src="images/OC/yasmine-kotturi.png" alt="Yasmine Kotturi">
    ...
    <p class="lead" style="font-size: 0.95rem;">University of Maryland, Baltimore County, USA</p>
  </div>
  <div class="col-md-3">
    <img class="photo-size rounded-circle ci-img" src="images/OC/Yaxing-Yao.jpeg" alt="Yaxing Yao">
    ...
    <p class="lead" style="font-size: 0.95rem;">Johns Hopkins University, USA</p>
  </div>
</div>
